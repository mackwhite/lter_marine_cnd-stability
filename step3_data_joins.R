...
cnd_comm <- read_csv("local_data/cnd_mdl_data_07162024.csv") |> 
      mutate(program = as.factor(program),
             habitat = as.factor(habitat),
             site = as.factor(site))

turnsynch <- read_csv("local_data/turnover_synchrony_07162024.csv") |> 
      mutate(program = as.factor(program),
             habitat = as.factor(habitat),
             site = as.factor(site))
...
# write_csv(all, "local_data/final_model_data_07162024.csv")
